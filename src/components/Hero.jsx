    ...
    >
      <div className="flex flex-col justify-center items-center mx-auto py-10">
        <div className="flex flex-col justify-center items-center">
          ...
          <a
            href="https://github.com/SolidityXplore/"
          ...
          >
            <div className="flex flex-col font-semibold">
              ...
              <span className="text-[#e32970] text-xs">Xplorer</span>
            </div>
          </a>

          <p className="text-white text-sm font-medium text-center">
            This project is dedicated by the members of the solidity xplorer
            developers. <br /> currently, the project is for the purpose of
            transparency on the blockchain. <br /> we believe this project would
            go a long way to achieving its purpose.
          </p>
          ...
          <ul className="flex flex-row justify-center space-x-2 items-center my-4">
            <a
              ...
              href="https://github.com/SolidityXplorer"
            >
