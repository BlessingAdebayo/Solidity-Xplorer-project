...
import { connectWallet } from "../Xplorer";
  ...
  return (
    <nav className="w-4/5 flex md:justify-center justify-between items-center py-4 mx-auto">
      <div className="flex flex-row justify-start items-center md:flex-[0.5] flex-initial">
        ...
        <span className="text-white text-2xl ml-2">Xplorer</span>
      </div>
      ...
      >
        <li className="mx-4 cursor-pointer">victor</li>
        <li className="mx-4 cursor-pointer">vincent</li>
        <li className="mx-4 cursor-pointer">blessing</li>
      </ul>
